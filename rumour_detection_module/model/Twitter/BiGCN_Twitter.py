...
import numpy as np
from rumour_detection_module.tools.earlystopping import EarlyStopping
...
def train_GCN(treeDic, x_test, x_train,TDdroprate,BUdroprate,lr, weight_decay,patience,n_epochs,batchsize,dataname, fold_num, ablation, iter):
    ...
    if not ablation:
        # Save model checkpoint after full training.
        save_path = os.path.join(os.path.dirname(
            os.path.abspath(__file__)), "model_weights", dataname + "_" + str(fold_num))
...
if __name__ == "__main__":
    ...
    if sys.argv[3] == "True":
        ...
        raise ValueError("Ablation needs to be True or False")
    model="GCN"
    test_accs = []
    NR_F1 = []
    FR_F1 = []
